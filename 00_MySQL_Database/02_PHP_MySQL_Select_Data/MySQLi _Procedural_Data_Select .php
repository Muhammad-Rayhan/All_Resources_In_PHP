<?php
    include "MySQLi_Procedural_connect";  //At first include database connect in this file.
    ...
    $result = mysqli_query($conn, $selectQuery);  //Insert query operation into a variable. & mysqli_query($our_connect_variable_name, $our_selectQuery_variable_name)
